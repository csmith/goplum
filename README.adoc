...
|`reminder`
|If set, a reminder alert will be sent periodically while a check remains in a failing state.
 A value of `0` disables reminders. The actual interval between reminders will be rounded up
 to the next multiple of the check interval.
|`0` (disabled)
|===
